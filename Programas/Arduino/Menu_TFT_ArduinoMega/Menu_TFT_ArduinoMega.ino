...
const int TS_LEFT=99,TS_RT=929,TS_TOP=66,TS_BOT=907;
...
void Selector_Menu(void)
{
    if(Menu==1)
    {
        tft.fillRect(10,70,310,20,TFT_WHITE);
        tft.fillRect(10,1000,310,20,TFT_BLACK);
    }
    if(Menu==2)
    {
        tft.fillRect(10,100,310,20,TFT_WHITE);
        tft.fillRect(10,70,310,20,TFT_BLACK);
    }
    
    return;
}

void Pantalla_Estatica(void)
{
